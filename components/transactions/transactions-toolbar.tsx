...
export function TransactionsToolbar() {
  return (
    <div className="mt-4 flex flex-wrap items-center justify-between gap-4 rounded-2xl bg-[#f9f9f9] p-4">
      <div className="flex w-full max-w-[360px] items-center gap-2 rounded-2xl bg-white px-3 py-2 shadow-sm">
        <svg viewBox="0 0 24 24" className="h-4 w-4 text-[#7d7d7d]" aria-hidden="true">
          <path
      ...
      <div className="flex items-center gap-3">
        <Button type="button" variant="primaryOutline" className="h-10 px-6 text-sm font-semibold">
        ...
        <Button type="button" variant="primary" className="h-10 px-6 text-sm font-semibold">
          <span className="mr-2 inline-flex h-4 w-4 items-center justify-center">
            <svg viewBox="0 0 24 24" className="h-4 w-4" aria-hidden="true">
              <path
